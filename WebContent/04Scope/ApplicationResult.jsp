...
<body>
	...
	<!-- 
		어플리케이션 영역에 저장된 속성은 페이지이동, 전달이 되더라도 그 영역이 공유되고,
		웹 브라우저를 종료했다가 다시 실행하더라도 그 영역이 공유된다.
		즉 한번 저장되면 웹서버가 셧다운(종료)될때 까지는 속성값이 유지된다.
	 -->
	...
	<h4>해당페이지에서만 사용가능하고, 페이지이동 또는 forward되면 해당 영역은 사라진다</h4>
	<%
