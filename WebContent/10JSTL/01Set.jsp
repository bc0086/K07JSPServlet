...
<body>
	...
	<h3>EL로 출력</h3>
	<!-- 
		EL로 여영ㄱ의 속성을 읽어올때는 XXXScope를 생략하면 가장 좁은
	...
	<!-- 
		영역에 저장될때는 Object타입으로 자동형변환 되므로 
    	사용시 해당 자료형으로 변환(다운캐스팅) 해야한다.
	 -->
	<h3>JSP코드로 출력</h3>
	<ul>
		<li>아이디:
	...
	<!-- 
		set태그의 target, property속성은 자바빈 객체의 속성 혹은 컬렉션의 값을
		설정할떄 사용하는 속성이다.
		...
		※target과 property를 사용해서 자바빈이나 컬렉션에 값을 설정할때는
			var 속성을 지정할 수 없다.
	 -->
