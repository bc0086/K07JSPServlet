...
public class MyTagLib {
	...
	/*
	 	메소드 설명 : 매개변수로 전달된 문자열에 숫자가 아닌 문자가 포함되어 있으면
	...
	/*
	 	메소드 설명 : 매개변수로 주민번호를 전달받아 성별을 판단하여 반환하는 메소드를 작성한다.
	 		주민번호는 123456-7890123 형태로 전달된다.
	 */
	public static String getGender(String jumin) {
		String returnStr = ""; // 변수 선언
	...
	/*
	 	아이디/패스워드, DB연결을 위한 드라이버, URL을 인자로 받아 회원여부를 판단하여 true/false를 반환해주는 메소드.
	 */
	public static boolean memberLogin(String id,String pw,String drv, String url) {// 파라미터 총 4개
